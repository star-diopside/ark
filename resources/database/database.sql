...
DROP TABLE IF EXISTS ATTACHED_FILE_DATA;
...
CREATE TABLE ATTACHED_FILE_DATA
(
	ID SERIAL NOT NULL,
...
ALTER TABLE ATTACHED_FILE_DATA
	ADD FOREIGN KEY (ATTACHED_FILE_ID)
	REFERENCES ATTACHED_FILES (ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
COMMENT ON COLUMN ATTACHED_FILES.ID IS 'ID';
COMMENT ON COLUMN ATTACHED_FILES.NAME IS 'ファイル名';
COMMENT ON COLUMN ATTACHED_FILES.CONTENT_TYPE IS 'コンテンツタイプ';
COMMENT ON COLUMN ATTACHED_FILES.SIZE IS 'ファイルサイズ';
...
COMMENT ON TABLE ATTACHED_FILE_DATA IS '添付ファイルデータ';
COMMENT ON COLUMN ATTACHED_FILE_DATA.ID IS 'ID';
COMMENT ON COLUMN ATTACHED_FILE_DATA.ATTACHED_FILE_ID IS '添付ファイルID';
COMMENT ON COLUMN ATTACHED_FILE_DATA.ORDER_BY IS '順序';
COMMENT ON COLUMN ATTACHED_FILE_DATA.DATA IS 'ファイルデータ';
COMMENT ON COLUMN ATTACHED_FILE_DATA.CREATED_AT IS '登録日時';
COMMENT ON COLUMN ATTACHED_FILE_DATA.CREATED_USER_ID IS '登録ユーザID';
COMMENT ON COLUMN ATTACHED_FILE_DATA.UPDATED_AT IS '更新日時';
COMMENT ON COLUMN ATTACHED_FILE_DATA.UPDATED_USER_ID IS '更新ユーザID';
COMMENT ON COLUMN ATTACHED_FILE_DATA.VERSION IS 'バージョン';
